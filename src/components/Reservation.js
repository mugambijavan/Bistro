...
const Reservation = () => {
  const {title, subtitle, subtitle2, modelImg, btnText } = reservationData;
    ...
    <section id='book' className=' relative top-96 z-30 pb-20 lg:py-[100px]'>
      <div className='container mx-auto'>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView={'show'} className='text-center'>
          ...
          <motion.p variants={fadeIn('up', 'tween', 0.4, 1.6)} className='mb-1 text-dark'>{subtitle}</motion.p>
          <motion.p variants={fadeIn('up', 'tween', 0.4, 1.6)} className='mb-8 text-dark'>{subtitle2}</motion.p>
